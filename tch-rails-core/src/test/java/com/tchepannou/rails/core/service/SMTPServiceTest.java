    ...
    extends AbstractServiceTest
{
        ...
        throws Exception
    {
        ...
        mc.setFrom ("ray.sponsible@gmail.com");
        ...
        assertEquals ("from", mc.getFrom (), msg.getFrom ()[0].toString ());
        assertEquals ("sender", getJavaMailProperties ().get(OptionService.OPTION_MAIL_FROM), msg.getSender ().toString ());
    }
    ...
    protected Properties getJavaMailProperties ()
    {
        ...
        prop.put (OptionService.OPTION_MAIL_SMTP_PORT, "25," + String.valueOf (SMTP_PORT));
        return prop;
    }
}
